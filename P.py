...
#aca va la parte del menu de configuracion que va a estar en la ventana
        ...
        boton_ok = Gtk.Button('OK')
        boton_ok.set_halign(Gtk.Align.CENTER)
        boton_ok.set_valign(Gtk.Align.CENTER)
        boton_ok.connect('clicked', self.enviar_caracteres)
...
#ponerlos en la ventana
        ...
        self.grid.attach_next_to(boton_ok, self.entrada_caracteres, Gtk.PositionType.BOTTOM, 1, 1)
        self.grid.attach_next_to(label_invertir, boton_ok, Gtk.PositionType.BOTTOM, 1, 1)
    ...
    def enviar_caracteres(self, widget):
        caracteres = self.entrada_caracteres.get_text()
        return caracteres
    ...
    #cargar el arte ascii a la par con las configuraciones que estan hasta el momento
            ...
            letras = str(self.enviar_caracteres)
...
#ACA EMPIEZA TODA LA PARTE DE PASAR UNA IMAGEN A ARTE ASCII
    ...
    def final_ascii(self, ruta, caracteres):
        ...
        self.pasar_a_ascii(image, str(self.enviar_caracteres))
